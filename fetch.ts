...
type Opts__fetch__etsy_listing_a1__s3 = {
	S3_BUCKET?:string
	KEY__A1__LISTING__ETSY?:string
}
export async function fetch__etsy_listing_a1__s3(opts:Opts__fetch__etsy_listing_a1__s3 = {}) {
	const {
...
export const fetch__arr__listing__etsy__s3 = fetch__etsy_listing_a1__s3
export async function _etsy_listing_a1__s3(opts = {}) {
	const response = await fetch__etsy_listing_a1__s3(opts)
	return response.json()
}
export const _arr__listing__etsy__s3 = _etsy_listing_a1__s3
...
type Opts__fetch__etsy_listing_a1 = {
	ETSY_API_KEY?:string
	ETSY_STORE_ID?:string
}
export async function fetch__etsy_listing_a1(opts:Opts__fetch__etsy_listing_a1 = {}) {
	const {
...
export const fetch__arr__listing__etsy = fetch__etsy_listing_a1
