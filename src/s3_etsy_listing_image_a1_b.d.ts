...
export declare const s3_etsy_listing_image_a1_b: import("@ctx-core/object").Be<s3_etsy_listing_image_a1_Ctx, "s3_etsy_listing_image_a1", Readable$<IListingImage[] | undefined>>;
