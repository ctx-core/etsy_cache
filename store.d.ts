...
export declare const b__ctx__listing__etsy: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<false | "" | 0 | {
    etsy_listing_a1__s3: any;
    a1__images__listing__etsy__s3: number | string[];
} | null | undefined>;
export declare const __ctx__listing__etsy: import("svelte/store").Readable<false | "" | 0 | {
    etsy_listing_a1__s3: any;
    a1__images__listing__etsy__s3: number | string[];
} | null | undefined>;
export declare const b__etsy_listing_a1__s3: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<unknown>;
export declare const __etsy_listing_a1__s3: import("svelte/store").Readable<unknown>;
export declare const b__a1__images__listing__etsy__s3: (ctx?: object | undefined, opts?: import("@ctx-core/object")._be_opts_type | undefined) => import("svelte/store").Readable<unknown>;
